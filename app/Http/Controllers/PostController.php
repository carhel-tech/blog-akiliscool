...
class PostController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        // $chemin_image = $request->file('picture')->storeAs("posts","s3");
        ...
        // 2. On upload l'image dans "posts" en conservant le nom de fichier d'origine

        $chemin_image = $request->file('picture')->storeAs(
            'posts',
        ...
        Post::create([
            "title" => $request->title,
            "picture" => $chemin_image, // Chemin et nom d'origine du fichier
            "content" => $request->content,
        ]);
